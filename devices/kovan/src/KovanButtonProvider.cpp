...
{
        publish();
        if (Button::A.isTextDirty())
                emit buttonTextChanged(A, text(A));
        if (Button::B.isTextDirty())
                emit buttonTextChanged(B, text(B));
        if (Button::C.isTextDirty())
                emit buttonTextChanged(C, text(C));
        if (Button::X.isTextDirty())
                emit buttonTextChanged(X, text(X));
        if (Button::Y.isTextDirty())
                emit buttonTextChanged(Y, text(Y));
        if (Button::Z.isTextDirty())
                emit buttonTextChanged(Z, text(Z));
